      ...
      <div className="w-full">
        <div className="sticky top-0">
          <div className="border-b-[0.5px] border-borderGrayPrimary">
            <StickyNav className={"transition-all"}>
              {!isSearching ?
                (
                  <div className="flex justify-between px-[13px] py-4">
                    <h1 className="text-xl font-bold">Đang theo dõi</h1>
                    <div className="flex items-center">
                      <MagnifyingGlassIcon className="ml-[3px] font-light inline-block align-middle text-textGray" onClick={() => setIsSearching(true)} />
                    </div>
                  </div>
                )
                :
                (<div className="px-[13px] py-4">
                  <div className="flex justify-between items-center">
                    <div className="relative w-full">
                      <MagnifyingGlassIcon className="absolute left-[10px] top-[50%] translate-y-[-50%] text-textGray ml-[3px] font-light" />
                    ...
                    <div>
                      <CloseExternalEventIcon className="text-textGray ml-[3px] font-light inline-block align-middle" onClick={() => setIsSearching(false)} />
                    </div>
                  </div>
                </div>)
              }
