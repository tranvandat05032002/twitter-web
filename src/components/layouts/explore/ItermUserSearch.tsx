...
const ItermUserSearch = ({ key, data }: { key: string, data: UserSearchType }) => {
    return (
        <div key={key} className="w-full flex items-center cursor-pointer justify-between text-sm py-[10px] my-[2px] px-2 hover:bg-iconBackgroundGray">
...
export default ItermUserSearch;