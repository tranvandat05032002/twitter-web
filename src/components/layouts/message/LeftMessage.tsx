                ...
                <div className="flex flex-col w-full absolute inset-0">
                    ...
                    <div className="backdrop-blur bg-black/40 sticky top-0 z-[100] w-[321px] h-max p-2">
                        ...
                        <div className="relative flex w-full pt-[12px]">
                            ...
                            <input type="text" placeholder='Tìm kiếm người dùng' className="pl-[40px] pr-[10px]  py-[5px] h-[36px] focus:outline-none border focus:border focus:border-borderBlue border-borderGrayPrimary placeholder:text-textGray placeholder:font-light placeholder:text-sm bg-black rounded-[30px] w-full text-sm font-light" />
                        </div>
                    </div>
